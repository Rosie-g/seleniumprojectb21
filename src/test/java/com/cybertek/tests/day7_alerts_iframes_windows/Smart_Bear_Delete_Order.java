...
import com.cybertek.utilities.RemoveName;
...
public class Smart_Bear_Delete_Order {
    ...
    @Test
    public void delete_order_test() throws InterruptedException {

        // #9: SmartBear delete order
...
//
        ...
        BrowserUtils.printNamesAndCities(driver);
